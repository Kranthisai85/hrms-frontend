...
export default function Payroll() {
  ...
  return (
    <div className="max-h-full bg-white text-gray-900 p-4">
      <div className="max-w-[1400px] mx-auto">
        <h1 className="text-2xl font-bold mb-4">Investment Declaration Management</h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="bg-white border border-gray-200 rounded-lg pl-8 pr-3 py-1.5 w-[250px] text-sm 
